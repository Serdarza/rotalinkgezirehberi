...
export const LEGAL_PAGES: LegalPageConfig[] = [
  {
    ...
    description:
      "Rotalink'in kişisel verileri nasıl işlediği, çerez kullanımı, Google AdSense reklamları ve KVKK kapsamındaki haklarınız hakkında ayrıntılı bilgi.",
    intro:
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Tarayıcı depolaması: Tema tercihi, favori tesisler ve reklam izleyerek açılan fiyat görüntüleme hakkı gibi tercihler yalnızca cihazınızda (localStorage / sessionStorage) tutulur.",
        ],
      },
      {
        heading: "3. Çerezler ve üçüncü taraf reklamları",
        paragraphs: [
          "Sitemizde deneyimi iyileştirmek ve reklam gösterimi yapmak için çerezler kullanılmaktadır. Çerezler; tercihlerinizi hatırlamak, site trafiğini ölçmek ve ilgi alanınıza uygun reklam sunmak için kullanılır.",
          "Google dahil üçüncü taraf sağlayıcılar, kullanıcıların bu siteye veya diğer sitelere yaptığı önceki ziyaretlere dayalı reklam yayınlamak için çerez kullanır. Google'ın reklam çerezi kullanması, kullanıcılara Rotalink ve internetteki diğer siteleri ziyaretlerine dayalı reklamlar sunmasına olanak tanır.",
          "Kişiselleştirilmiş reklamları Google Reklam Ayarları sayfasından devre dışı bırakabilirsiniz. Üçüncü taraf sağlayıcıların çerez kullanımını www.aboutads.info adresinden yönetebilirsiniz. Ayrıca tarayıcınızın ayarlarından tüm çerezleri engelleyebilir veya silebilirsiniz; bu durumda sitenin bazı bölümleri beklendiği gibi çalışmayabilir.",
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          "Kişisel verilerinizi satmayız, kiralamayız veya pazarlama amacıyla üçüncü kişilere aktarmayız. Veriler yalnızca hizmetin yürütülmesi için zorunlu olan altyapı sağlayıcılarıyla (barındırma, reklam ağı) ve yasal zorunluluk hâlinde yetkili kamu kurumlarıyla paylaşılabilir.",
        ],
      },
      {
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        heading: "7. Reklamlar",
        paragraphs: [
          "Platform, ücretsiz kalabilmek için Google AdSense üzerinden reklam gösterir. Reklam içerikleri Rotalink tarafından belirlenmez ve reklamı yapılan ürün ya da hizmetler Rotalink tarafından onaylanmış sayılmaz.",
        ],
      },
      {
  ...
  },
  {
    ...
    description:
      "Rotalink'te kullanılan çerez türleri, Google AdSense reklam çerezleri ve çerez tercihlerinizi nasıl yönetebileceğiniz.",
    intro:
    ...
    sections: [
      {
        ...
        bullets: [
          ...
          "Reklam çerezleri: Google AdSense tarafından, ilgi alanınıza uygun reklam göstermek ve aynı reklamı defalarca göstermemek için kullanılır.",
        ],
      },
      {
        heading: "2. Google AdSense çerezleri",
        paragraphs: [
          "Google dahil üçüncü taraf sağlayıcılar, kullanıcıların bu siteye ve internetteki diğer sitelere yaptığı ziyaretlere dayalı reklam sunmak için çerez kullanır. Google, reklamlarını Rotalink üzerinde göstermek için DoubleClick DART çerezini kullanabilir.",
          "Kişiselleştirilmiş reklamları Google Reklam Ayarları üzerinden kapatabilirsiniz. Bu durumda reklam görmeye devam edersiniz, ancak reklamlar ilgi alanlarınıza göre seçilmez.",
        ],
      },
      {
      ...
      {
        heading: "4. Üçüncü taraf içerikler",
        paragraphs: [
          "Harita (OpenStreetMap tabanlı), hava durumu servisi ve reklam ağı gibi bazı özellikler dış sağlayıcılardan yüklenir. Bu sağlayıcılar kendi çerez politikalarını uygular.",
        ],
      },
      {
        heading: "5. Güncellemeler",
        paragraphs: [
